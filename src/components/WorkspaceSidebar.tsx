                  ...
                  <CardContent className="p-3">
                    <CalendarComponent
                      ...
                      classNames={{
                        ...
                        // Remove square highlight on selected cell and style the day instead
                        cell: "text-center text-xs p-0 relative focus-within:relative focus-within:z-20",
                        day: "h-8 w-8 p-0 font-normal text-xs aria-selected:opacity-100 hover:bg-accent/70 hover:text-accent-foreground rounded-full transition-colors",
                        day_selected: "bg-primary text-primary-foreground rounded-full ring-2 ring-primary/30 shadow-md hover:bg-primary focus:bg-primary focus:text-primary-foreground",
